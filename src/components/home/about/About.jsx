  ...
  return (
    <>
        <section className='about back'>
            <Heading sectionTitle='Who We Are?' subtitle='Exploring Our Identity and Commitment to You'></Heading>
                ...
                <div className="content grid4">
                    {about.map((val,index) => {
                        ...
                        <div className='box' key={index}>       
                            ...
                            <p className='box-numbers'>{val.num}</p>
                            <p className='box-name'>{val.name}</p>
                        </div>
                        )
                    })}
                </div>
